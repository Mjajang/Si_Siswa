...
$mapel = query("SELECT * FROM mapel ORDER BY id DESC");
...
<body>
  ...
  <a href="tambah_mapel.php" class="btn btn-primary" id="addkelas" style="margin-left: 13px;">Tambah data mata pelajaran</a>
      ...
      <tbody>
        ...
        <?php foreach ($mapel as $row) : ?>
          <tr class="align-middle">
            <td><?= $i; ?></td>
            <td>
              <a href="detail_mapel.php?id=<?= $row["id"] ?>" class="btn btn-primary btn-sm">Lihat</a> |
              <a href="edit_mapel.php?id=<?= $row["id"]; ?>" class="btn btn-warning btn-sm" style="color: white;">Edit</a> |
              <a href="hapus_mapel.php?id=<?= $row["id"]; ?>" onclick="return confirm('yakin dihapus?');" class="btn btn-danger btn-sm">Hapus</a>
            </td>
            <td><?= $row["nm_mapel"] ?></td>
          </tr>
          <?php $i++; ?>
