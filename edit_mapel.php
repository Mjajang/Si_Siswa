...
$mapel = query("SELECT * FROM mapel WHERE id = $id")[0];


if (isset($_POST["submit"])) {
    if (edit_mapel($_POST) > 0) {
        echo "<script>alert('Data berhasil diedit!'); document.location.href='mapel.php';</script>";
    } else {
                        ...
                        <form action="" method="post">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input class="form-control" type="text" name="nm_mapel" value="<?= $mapel["nm_mapel"]; ?>" required>
                                </div>
                            </div>
                            <button type="submit" name="submit" class="btn btn-primary">Edit Data</button>
                            <a href="mapel.php" class="btn btn-dark">Batal</a>
                        </form>
                    </div>
                </div>
            </div>
