...
if (isset($_POST["submit"])) {
    if (edit_kelas($_POST) > 0) {
        echo "<script>alert('Data berhasil diedit!'); document.location.href='kelas.php';</script>";
    } else {
        echo "<script>alert('Data gagal diedit!'); document.location.href='kelas.php';</script>";
    }
}
                    ...
                    <div class="col">
                        <form action="" method="post">
                            <div class="mb-3">
                                ...
                                <label for="tier" class="form-label mt-3">Kelas:</label>
                                <label for="nmkelas">Nama Kelas: </label>
                                <div class="input-group">
                                    <input class="form-control" type="text" name="nmkelas" value="<?= $kelas["nmkelas"]; ?>" required>
                                </div>
                            </div>
